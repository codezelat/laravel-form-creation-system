        ...
        <a href="{{ route('admin.forms.create') }}" class="group bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl shadow-sm p-8 hover:shadow-lg transition-all transform hover:-translate-y-1">
            <div class="flex items-center space-x-4">
                <div class="w-16 h-16 bg-white bg-opacity-20 rounded-xl flex items-center justify-center group-hover:bg-opacity-30 transition">
                    <!-- Use a filled plus icon with a contrasting blue color so it remains visible on the semi-transparent white background -->
                    <svg class="w-8 h-8 text-blue-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                    ...
                    <div class="px-6 py-4 hover:bg-gray-50 transition-colors">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center space-x-4 flex-1 min-w-0">
                                <div class="w-12 h-12 rounded-lg bg-gradient-to-br from-{{ $formColor }}-400 to-{{ $formColor }}-600 flex items-center justify-center flex-shrink-0">
